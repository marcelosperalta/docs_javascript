...
[String.fromCodePoint()](https://github.com/marcelosperalta/study_javascript/blob/master/doc_mdn/mdn.js#L95) | Returns a string created by using the specified sequence of code points.  
