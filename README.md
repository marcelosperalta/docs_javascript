...
[String.prototype.codePointAt()](https://github.com/marcelosperalta/study_javascript/blob/master/mdn.js#L49) | Returns a non-negative integer that is the UTF-16 code point value.<br/>  
