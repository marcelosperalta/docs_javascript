...
* [Quick Reference](https://github.com/marcelosperalta/study_javascript#dash-quick-reference)  
  * [Built-in objects List](https://github.com/marcelosperalta/study_javascript#built-in-objects-list)  
  * [Built-in objects Short Description](https://github.com/marcelosperalta/study_javascript#built-in-objects-short-description)  
  * [Statements & declarations Description](https://github.com/marcelosperalta/study_javascript#statements--declarations-short-description)  
...
[Array.prototype.every()](https://github.com/marcelosperalta/study_javascript/blob/master/doc_mdn/array.js#L) | Tests whether all elements in the array pass the test implemented by the provided function. It returns a Boolean value.  
[Array.prototype.fill()](https://github.com/marcelosperalta/study_javascript/blob/master/doc_mdn/array.js#L) | Changes all elements in an array to a static value, from a start index (default 0) to an end index (default array.length). It returns the modified array.  
[Array.prototype.filter()](https://github.com/marcelosperalta/study_javascript/blob/master/doc_mdn/array.js#L) | ``Creates a new array`` with all elements that pass the test implemented by the provided function.  
[Array.prototype.find()](https://github.com/marcelosperalta/study_javascript/blob/master/doc_mdn/array.js#L) | Returns the value of the first element in the provided array that satisfies the provided testing function. If no values satisfy the testing function, ``undefined`` is returned.  
[Array.prototype.findIndex()](https://github.com/marcelosperalta/study_javascript/blob/master/doc_mdn/array.js#L) | Returns the ``index`` of the first element in the array ``that satisfies the provided testing function``. Otherwise, it returns ``-1``, indicating that no element passed the test.  
[Array.prototype.flat()](https://github.com/marcelosperalta/study_javascript/blob/master/doc_mdn/array.js#L) | Creates a new array with all sub-array elements concatenated into it recursively up to the specified depth.  
[Array.prototype.flatMap()](https://github.com/marcelosperalta/study_javascript/blob/master/doc_mdn/array.js#L) | Returns a new array formed by applying a given callback function to each element of the array, and then flattening the result by one level. It is identical to a`` map()`` followed by a ``flat()`` of depth 1, but slightly more efficient than calling those two methods separately.  
[Array.prototype.forEach()](https://github.com/marcelosperalta/study_javascript/blob/master/doc_mdn/array.js#L) | Executes a provided function once for each array element.  
[Array.from()](https://github.com/marcelosperalta/study_javascript/blob/master/doc_mdn/array.js#L) | Creates a new, shallow-copied Array instance from an array-like or iterable object.  
[Array.prototype.includes()](https://github.com/marcelosperalta/study_javascript/blob/master/doc_mdn/array.js#L) | Determines whether an array includes a certain value among its entries, returning ``true`` or ``false`` as appropriate.  
[Array.prototype.indexOf()](https://github.com/marcelosperalta/study_javascript/blob/master/doc_mdn/array.js#L) | Returns the first index at which a given element can be found in the array, or -1 if it is not present.  
[Array.isArray()](https://github.com/marcelosperalta/study_javascript/blob/master/doc_mdn/array.js#L) | Determines whether the passed value is an Array.  
[Array.prototype.join()](https://github.com/marcelosperalta/study_javascript/blob/master/doc_mdn/array.js#L) | Creates and returns a new string by concatenating all of the elements in an array (or an array-like object), separated by commas or a specified separator string. If the array has only one item, then that item will be returned without using the separator.  
[Array.prototype.keys()](https://github.com/marcelosperalta/study_javascript/blob/master/doc_mdn/array.js#L) | Returns a new **Array Iterator** object that contains the keys for each index in the array.  
[Array.prototype.lastIndexOf()](https://github.com/marcelosperalta/study_javascript/blob/master/doc_mdn/array.js#L) | Returns the last index at which a given element can be found in the array, or -1 if it is not present. The array is searched backwards, starting at ``fromIndex``.  
[Array.prototype.map()](https://github.com/marcelosperalta/study_javascript/blob/master/doc_mdn/array.js#L) | **Creates a new array** populated with the results of calling a provided function on every element in the calling array.  
[Array.of()](https://github.com/marcelosperalta/study_javascript/blob/master/doc_mdn/array.js#L) | Creates a new Array instance from a variable number of arguments, regardless of number or type of the arguments.  
[Array.prototype.pop()](https://github.com/marcelosperalta/study_javascript/blob/master/doc_mdn/array.js#L) | Removes the **last** element from an array and returns that element. This method changes the length of the array.  
[Array.prototype.push()](https://github.com/marcelosperalta/study_javascript/blob/master/doc_mdn/array.js#L) | Adds one or more elements to the end of an array and returns the new length of the array.  
[Array.prototype.reduce()](https://github.com/marcelosperalta/study_javascript/blob/master/doc_mdn/array.js#L) | Executes a user-supplied “reducer” callback function on each element of the array, passing in the return value from the calculation on the preceding element. The final result of running the reducer across all elements of the array is a single value.  
[Array.prototype.reduceRight()](https://github.com/marcelosperalta/study_javascript/blob/master/doc_mdn/array.js#L) | Applies a function against an accumulator and each value of the array (from right-to-left) to reduce it to a single value.  
[Array.prototype.reverse()](https://github.com/marcelosperalta/study_javascript/blob/master/doc_mdn/array.js#L) | Reverses an array _in place_. The first array element becomes the last, and the last array element becomes the first.  
[Array.prototype.shift()](https://github.com/marcelosperalta/study_javascript/blob/master/doc_mdn/array.js#L) | Removes the **first** element from an array and returns that removed element. This method changes the length of the array.  
[Array.prototype.slice()](https://github.com/marcelosperalta/study_javascript/blob/master/doc_mdn/array.js#L) | Returns a shallow copy of a portion of an array into a new array object selected from ``start`` to ``end`` (``end`` not included) where ``start`` and ``end`` represent the index of items in that array. The original array will not be modified.  
[Array.prototype.some()](https://github.com/marcelosperalta/study_javascript/blob/master/doc_mdn/array.js#L) | Tests whether at least one element in the array passes the test implemented by the provided function. It returns true if, in the array, it finds an element for which the provided function returns true; otherwise it returns false. It doesn't modify the array.  
[Array.prototype.sort()](https://github.com/marcelosperalta/study_javascript/blob/master/doc_mdn/array.js#L) | Sorts the elements of an array _in place_ and returns the sorted array. The default sort order is ascending, built upon converting the elements into strings, then comparing their sequences of UTF-16 code units values.  
[Array.prototype.splice()](https://github.com/marcelosperalta/study_javascript/blob/master/doc_mdn/array.js#L) | Changes the contents of an array by removing or replacing existing elements and/or adding new elements _in place_. To access part of an array without modifying it, see ``slice()``.  
[Array.prototype.toLocaleString()](https://github.com/marcelosperalta/study_javascript/blob/master/doc_mdn/array.js#L) | Returns a string representing the elements of the array. The elements are converted to Strings using their ``toLocaleString`` methods and these Strings are separated by a locale-specific String (such as a comma “,”).  
[Array.prototype.toString()](https://github.com/marcelosperalta/study_javascript/blob/master/doc_mdn/array.js#L) | Returns a string representing the specified array and its elements.  
